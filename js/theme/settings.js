(() => {
  ...
  const DEFAULTS = Object.freeze({ enabled: false, theme: 'system', density: 'comfortable', fontSize: 16, contentWidth: 'standard', hidePromotions: true, hideSignatures: true, compactProfiles: true });
  const PREFIX = 'rfdm.';
